...
export default function SubscriptionsPage() {
    ...
    return (
        <div className="flex flex-col gap-6 px-2 md:px-8 py-6 w-full">
            ...
            {/* Header */}
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-2 gap-2 sm:gap-4">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Subscriptions</h1>
                <button onClick={() => { setShowForm(true); setForm(initialForm); setEditId(null); }} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg flex items-center transition-colors shadow-sm hover:shadow-md w-full sm:w-auto justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-2">
                <div className="p-4 sm:p-5 rounded-lg bg-blue-50">
                    <h3 className="text-xs sm:text-sm font-medium text-blue-800">Total Subscriptions</h3>
                    <p className="text-xl sm:text-2xl font-bold text-blue-600">{filteredSubscriptions.length}</p>
                </div>
                <div className="p-4 sm:p-5 rounded-lg bg-indigo-50">
                    <h3 className="text-xs sm:text-sm font-medium text-indigo-800">Total Amount</h3>
                    <p className="text-xl sm:text-2xl font-bold text-indigo-600">₹{totalAmount.toLocaleString()}</p>
                </div>
            </div>
            {/* Next Billing Reminder */}
            {nextSubscription && (
                <div className="mb-2 p-2 sm:p-3 bg-indigo-50 border-l-4 border-indigo-400 text-indigo-900 rounded text-xs sm:text-base">
            ...
            {/* Filters */}
            <Card className="mb-2">
                <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-between gap-2 sm:gap-4 mb-2">
